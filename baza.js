const BAZA_OSTRZEZEN = {
  ...
  "Grabów": [
    ["51.853", "53.916", "Uszkodzone części rozj. nr 4", "2", "20", "20", "* ) Nowe!"]
  ],
  "Grębów": [
  ...
  "Kowalewo": [
    ...
    ["2.259", "2.275", "", "2", "50", "50", ""],
    ["2.261", "2.279", "przekroczony iloczyn ruchu na przejeździe", "1", "50", "50", "tylko czoło"],
    ["216.635", "216.678", "zły stan wiaduktu", "1", "40", "40", ""],
    ["216.635", "216.678", "zły stan wiaduktu", "2", "40", "40", ""],
    ["218.768", "219.926", "zły stan podkładów", "3", "20", "20", ""],
    ["218.768", "219.926", "zły stan podkładów", "4", "20", "20", ""],
    ["218.858", "219.740", "zły stan podtorza", "11", "20", "20", ""],
    ["220.537", "221.177", "zły stan toru i podtorza", "1", "80", "80", ""],
    ["220.537", "221.177", "zły stan toru i podtorza", "2", "80", "80", ""]
  ],
  "Kraśnica": [
  ...
  "LCS Kleszczów": [
    ...
    ["167.904", "167.928", "obiekt mostowy nie do 160 km/h", "1", "120", "120", ""]
  ],
  "LCS Perzów": [
    ["51.189", "51.637", "Zły stan toru", "11", "20", "20", ""]
  ],
  "LCS Żywiec": [
    ["56.300", "56.700", "krótka krzywa - brak widoczności", "1", "30", "30", "139"],
    ["69.343", "69.359", "zły stan podtorza", "1", "30", "30", ""],
    ["72.320", "72.360", "zły stan przepustu km 75.458", "1", "40", "40", ""],
    ["75.453", "75.463", "", "1", "40", "40", "wprost i zwrotny"],
    ["85.285", "86.115", "brak widoczności przejazdy 85.411|85.831|85.988", "1", "40", "40", "Nowe!"]
  ],
  "Lilianowo": [
    ["56.581", "56.700", "zły stan mostownic i widoczność", "1", "10", "10", ""]
  ],
  "Lisków": [
  ...
  "Modlinków": [
    ["19.532", "19.548", "ograniczona widoczność na przejeździe", "1", "30", "30", "tylko czoło"],
    ["20.524", "20.562", "zły stan toru", "1", "20", "20", ""]
  ],
  "Nowa Wieś Wielka": [
  ...
  "Orniki": [
    ["44.749", "44.856", "Prace przy budowie wiaduktu", "1,2", "70", "70", "Nowe"],
    ["45.959", "45.992", "Zły stan rozjazdu nr 22", "", "30", "30", ""],
    ["46.755", "47.933", "Zły stan toru i podtorza", "1", "30", "20", ""],
    ["132.026", "132.042", "przekroczony iloczyn i widoczność", "1", "20", "20", "tylko czoło"]
  ],
  "Pszczyna": [
  ...
  "Sierakówek": [
    ["19.090", "19.420", "ograniczona widoczność", "1", "60", "-", "33"],
    ["19.940", "20.650", "zły stan toru", "2", "20", "20", ""]
  ],
  "Skawce": [
    ["37.300", "37.450", "uszkodzenie konstrukcji mostu", "1", "30", "30", ""]
  ],
  "Skawce Sucha Beskidzka": [
    ["40.500", "40.750", "układ geometryczny toru", "1", "60", "60", ""],
    ["40.750", "40.850", "niestabilność podtorza", "1", "40", "40", ""],
    ["40.850", "41.400", "układ geometryczny toru", "1", "60", "60", ""],
    ["41.400", "42.000", "", "1", "50", "50", ""]
  ],
  "Skrzynki": [
    ["47.800", "48.580", "zły stan toru", "4", "20", "20", "25"]
  ],
  "Stefanowo": [
    ["35", "", "", "", "", "", ""],
    ["61.956", "62.231", "ograniczona widoczność", "1", "50", "", "tylko czoło"]
  ],
  "Strzelce Kujawskie": [
    ["13.545", "14.283", "zły stan toru i podkładów", "3", "20", "20", "33"]
  ],
  "Sucha Beskidzka": [
    ["-0.480", "0.300", "zły stan techniczny toru", "2", "30", "30", "98"],
    ["1.067", "", "Przejazd - brak widoczności", "", "30", "30", ""],
    ["45.191", "", "Przejazd - brak widoczności", "", "30", "30", "97"],
    ["51.700", "51.750", "Zły stan toru w przejeździe", "", "30", "30", "autobusy szynowe"]
  ],
  "Suszec": [
    ["17.600", "19.000", "Nierówność pionowa na szkodach górniczych", "1", "30", "30", "148"]
  ],
  "Tarkowice": [
    ["112.461", "112.537", "realizacja inwestycji", "1,2", "60", "60", ""]
  ],
  "Trzymałkowice": [
  ...
  "Wijewo": [
    ["42.833", "43.497", "Tor po naprawie", "1,2", "30", "30", "doraźne"],
    ["44.798", "45.097", "niestabilne podtorze", "1", "80", "80", ""],
    ["44.798", "45.097", "niestabilne podtorze", "2", "80", "80", ""],
    ["45.600", "45.635", "zły stan rozjazdu nr 31", "5", "50", "50", ""],
    ["45.677", "45.781", "zły stan rozjazdu 8", "4", "20", "20", ""],
    ["45.832", "46.571", "zły stan toru", "6", "20", "20", "doraźne"],
    ["46.441", "46.454", "waga wagonowa", "10", "10", "10", ""],
  ...
  "Wronowice": [
    ...
    ["76.845", "76.945", "zły stan toru", "1", "40", "40", ""]
  ],
  "Zakopane": [
    ["41.000", "41.065", "przejazdy brak widoczności + zły stan mostu km 41.042", "1", "30", "30", ""],
    ["41.807", "43.200", "R=295,245,214,238,303 m brak kp", "2", "140", "40", ""]
  ],
  "Zawadówka": [
  ...
  "Zielona Góra Główna": [
    ["0.000", "0.800", "", "-", "46", "60", "T 370"],
    ["0.000", "0.800", "", "-", "47", "70", "370"],
    ["0.900", "0.960", "układ geometryczny toru", "4", "40", "40", "370"],
